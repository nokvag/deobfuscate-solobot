...
async def on_startup(lqCBDe1lOEOd):
...
async def on_shutdown(lqCBDe1lOEOd):
...
async def main():
    ...
    if DEV_MODE:
        ...
        lqCBDe1lOEOd.on_startup.append(on_startup)
        lqCBDe1lOEOd.on_shutdown.append(on_shutdown)
        if YOOKASSA_ENABLE:
        ...
        runner = web.AppRunner(lqCBDe1lOEOd)
        await runner.setup()
