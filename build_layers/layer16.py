...
create_engine, text = (importlib.import_module('sqlalchemy').create_engine, importlib.import_module('sqlalchemy').text)
Config, = (importlib.import_module('alembic.config').config.Config,)
ScriptDirectory, = (importlib.import_module('alembic.script').script.ScriptDirectory,)
DATABASE_URL, = (importlib.import_module('config').DATABASE_URL,)
...
SimpleRequestHandler, setup_application = (importlib.import_module('aiogram.webhook.aiohttp_server').webhook.aiohttp_server.SimpleRequestHandler, importlib.import_module('aiogram.webhook.aiohttp_server').webhook.aiohttp_server.setup_application)
web, = (importlib.import_module('aiohttp').web,)
AsyncIOScheduler, = (importlib.import_module('apscheduler.schedulers.asyncio').schedulers.asyncio.AsyncIOScheduler,)
CronTrigger, = (importlib.import_module('apscheduler.triggers.cron').triggers.cron.CronTrigger,)
backup_database, = (importlib.import_module('backup').backup_database,)
bot, dp = (importlib.import_module('bot').bot, importlib.import_module('bot').dp)
BACKUP_TIME, CRYPTO_BOT_ENABLE, DEV_MODE, PING_TIME, ROBOKASSA_ENABLE, SUB_PATH, WEBAPP_HOST, WEBAPP_PORT, WEBHOOK_PATH, WEBHOOK_URL, YOOKASSA_ENABLE, YOOMONEY_ENABLE, API_ENABLE, API_HOST, API_PORT, API_LOGGING, FREEKASSA_ENABLE = (importlib.import_module('config').BACKUP_TIME, importlib.import_module('config').CRYPTO_BOT_ENABLE, importlib.import_module('config').DEV_MODE, importlib.import_module('config').PING_TIME, importlib.import_module('config').ROBOKASSA_ENABLE, importlib.import_module('config').SUB_PATH, importlib.import_module('config').WEBAPP_HOST, importlib.import_module('config').WEBAPP_PORT, importlib.import_module('config').WEBHOOK_PATH, importlib.import_module('config').WEBHOOK_URL, importlib.import_module('config').YOOKASSA_ENABLE, importlib.import_module('config').YOOMONEY_ENABLE, importlib.import_module('config').API_ENABLE, importlib.import_module('config').API_HOST, importlib.import_module('config').API_PORT, importlib.import_module('config').API_LOGGING, importlib.import_module('config').FREEKASSA_ENABLE)
async_session_maker, init_db = (importlib.import_module('database').async_session_maker, importlib.import_module('database').init_db)
router, = (importlib.import_module('handlers').router,)
send_daily_stats_report, = (importlib.import_module('handlers.admin.stats.stats_handler').admin.stats.stats_handler.send_daily_stats_report,)
fallback_router, = (importlib.import_module('handlers.fallback_router').fallback_router.fallback_router,)
handle_subscription, = (importlib.import_module('handlers.keys.subscriptions').keys.subscriptions.handle_subscription,)
periodic_notifications, = (importlib.import_module('handlers.notifications.general_notifications').notifications.general_notifications.periodic_notifications,)
cryptobot_webhook, = (importlib.import_module('handlers.payments.cryprobot_pay').payments.cryprobot_pay.cryptobot_webhook,)
validate_client_code, = (importlib.import_module('handlers.payments.gift').payments.gift.validate_client_code,)
robokassa_webhook, = (importlib.import_module('handlers.payments.robokassa_pay').payments.robokassa_pay.robokassa_webhook,)
MAIN_SECRET, yookassa_webhook = (importlib.import_module('handlers.payments.yookassa_pay').payments.yookassa_pay.MAIN_SECRET, importlib.import_module('handlers.payments.yookassa_pay').payments.yookassa_pay.yookassa_webhook)
yoomoney_webhook, = (importlib.import_module('handlers.payments.yoomoney_pay').payments.yoomoney_pay.yoomoney_webhook,)
freekassa_webhook, = (importlib.import_module('handlers.payments.freekassa_pay').payments.freekassa_pay.freekassa_webhook,)
logger, = (importlib.import_module('logger').logger,)
register_middleware, = (importlib.import_module('middlewares').register_middleware,)
check_servers, = (importlib.import_module('servers').check_servers,)
register_web_routes, = (importlib.import_module('web').register_web_routes,)
