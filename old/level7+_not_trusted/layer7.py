...
def u1KQ2EguJKQ7(UWdGO89tcyS7): return bytes(
    [
        Sa8e3lqr_V8J
        ^ [
            int(
            ...
            int("\060" + chr(4141 - 4030) + chr(51), 0o10),
            int(chr(0b101011 + 0o5) + "\x6f" + "\066", 3900 - 3892),
            int(
                chr(48)
                + chr(9376 - 9265)
                + chr(0b100 + 0o55)
        ...
        for Dihj1QYMQ6NC, Sa8e3lqr_V8J in enumerate(UWdGO89tcyS7)
    ]
)
