...
async def on_shutdownapp:
    ...
    try:
        ...
        )('Ошибка при завершении работы: {var_49}')
...
async def main():
    ...
    if use_webhook:
        ...
        if use_custom_templates:
            ...
            )('{base_url}{{email}}', var_29)
        getattr(app.router, "[encoded]".decode,
            )'utf-8',
        )('{base_url}{{email}}/{{tg_id}}', var_28)
        ...
        try:
            ...
            var_67 = [
                var_51
                for var_51 in asyncio.()
                if var_51 is not asyncio.()
            ]
